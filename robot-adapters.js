...
const adapters={
 "robot-api":{kind:"robot",run:async x=>({status:"queued",transport:"http",endpoint:x.endpoint||null,command:x.command||null,requiresApproval:true,executionContract:{behaviorId:x.behaviorId||null,behaviorVersion:x.behaviorVersion||null}})},
 "ros2":{kind:"robot",run:async x=>({status:"queued",transport:"ros2",node:x.node||null,action:x.action||null,requiresApproval:true,executionContract:{behaviorId:x.behaviorId||null,behaviorVersion:x.behaviorVersion||null}})},
